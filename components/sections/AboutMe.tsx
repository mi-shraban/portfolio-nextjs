            ...
            <h2>About Me</h2>
                <div className="card">
                    <p>Hello there! This is Monowarul Islam, you can also call me Shraban. I am a Computer Science graduate
                        ...
                        conferral.I enjoy programming challenges, I have solved over <a className="ab_link" href="/cfsolves" target="_blank">250 problems on Codeforces</a>
                        ...
                        experience and implement my skills in the real world environment. You can find my resume
                        <a className="ab_link" href={resumePdf} target="_blank">here</a>.
                        <br/>
