...
export default function AboutMe() {
    return (
        <section id="aboutme" className="section">
            <h2>About Me</h2>
                <div className="card">
                    <p>Hello there! This is Monowarul Islam, you can also call me Shraban. I am a Computer Science
                        graduate
                        ...
                        industry
                        experience and implement my skills in the real world environment. You can find my resume <a
                            className="ab_link"
