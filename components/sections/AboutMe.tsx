...
export default function AboutMe() {
    return (
        <section id="aboutme" className="section">
            <h2>About Me</h2>
                <div className="card">
                    <p>Hello there! This is <strong>Monowarul Islam</strong>, you can also call me <strong>Shraban</strong>.
                        ...
                        learning. I have also gained experience by working on a few projects which required me to study
                        ...
                        intrusion
                        detection with traditional solutions. My research role included optimizing ML models, handling
                        large datasets
                        and implementing the ML algorithms to produce optimal results. Currently, I am working on
                        furthering the
                        research works from the thesis. Alongside that, I am also looking for opportunities to gain
                        industry
                        experience and implement my skills in the real world environment. You can find my <strong>resume</strong> <a
                            className="ab_link"
